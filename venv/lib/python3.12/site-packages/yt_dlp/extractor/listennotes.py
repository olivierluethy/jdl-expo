...
class ListenNotesIE(InfoExtractor):
    ...
    _TESTS = [{
        ...
        'info_dict': {
            ...
            'channel_url': 'https://www.listennotes.com/podcasts/a__REDACTED_OPENAI_KEY__/',
            'thumbnail': 'https://cdn-images-3.listennotes.com/podcasts/a__REDACTED_OPENAI_KEY__.300x300.jpg',
