...
class Canal1IE(InfoExtractor):
    ...
    _TESTS = [{
        ...
        'url': 'https://noticias.canal1.com.co/noticias/tres-i-el-triste-record-que-impuso-elon-mu__REDACTED_OPENAI_KEY__/',
        'info_dict': {
            'id': '63b39e93f5fd223aa32250fb',
            'display_id': 'tres-i-el-triste-record-que-impuso-elon-mu__REDACTED_OPENAI_KEY__',
